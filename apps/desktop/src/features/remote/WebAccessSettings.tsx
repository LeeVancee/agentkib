        ...
        <>
          ...
          <SettingsRow>
            ...
            <Input
              ...
              disabled={busy}
              onChange={(e: any) =>
                setConfig({ ...config, port: Number((e.target as HTMLInputElement).value) })
              }
            />
          </SettingsRow>
          {lan ? (
            <>
              <SettingsRow>
                ...
                <Select
                  ...
                  disabled={busy}
                  onValueChange={(value: any) => setConfig({ ...config, lanAddress: value || "" })}
                >
            ...
            <SettingsRow>
              ...
              <Input
                ...
                disabled={busy}
                onChange={(e: any) =>
                  setConfig({ ...config, externalOrigin: (e.target as HTMLInputElement).value })
                }
              />
            </SettingsRow>
          )}
          ...
          <div className="flex flex-wrap items-start gap-4">
            ...
            <div className="min-w-0 flex-1 space-y-2 break-all">
              ...
              <Input
                ...
                onFocus={(event: any) => (event.target as HTMLInputElement).select()}
              />
            </div>
          </div>

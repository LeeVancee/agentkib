const zh = {
  ...
  message: "发送消息",
  experimental: "实验控制",
  controlInfo: "仅在明确空闲时发送；运行中可停止当前轮次，不排队。",
  ...
  warnings: "读取警告",
  tool: "工具摘要",
  toolSummaryUnavailable: "历史记录未提供工具输入与输出。",
  readOnly: "当前浏览器仅可读取",
...
const en: Words = {
  ...
  unsupportedControl:
    "Live control is not supported for this platform or Agent. History remains readable.",
  ...
  controlInfo: "Send only when confirmed idle; stop the current turn while running. No queueing.",
  ...
  tool: "Tool summary",
  toolSummaryUnavailable: "The history does not provide tool input or output.",
...
const tw: Words = {
  ...
  message: "傳送訊息",
  experimental: "實驗控制",
  controlInfo: "僅在明確閒置時傳送；執行中可停止目前輪次，不排隊。",
  ...
  warnings: "讀取警告",
  tool: "工具摘要",
  toolSummaryUnavailable: "歷史記錄未提供工具輸入與輸出。",
  readOnly: "目前瀏覽器僅可讀取",
...
const ja: Words = {
  ...
  unsupportedControl:
    "このプラットフォームまたは Agent はリアルタイム制御に対応していません。履歴は閲覧できます。",
  process: "実行過程",
  tools: "回のツール呼び出し",
  failed: "失敗",
  ...
  experimental: "実験的な操作",
  controlInfo:
    "待機状態が確認されたときのみ送信し、実行中は現在のターンを停止できます。キューは利用できません。",
  ...
  warnings: "読み取りの警告",
  tool: "ツールの概要",
  toolSummaryUnavailable: "履歴にはツールの入力と出力が含まれていません。",

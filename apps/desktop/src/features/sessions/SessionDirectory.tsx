...
import { Fragment, useLayoutEffect, useRef } from "octane";
import { Ellipsis, Folder, FolderOpen, GitBranch, Monitor, X } from "@octanejs/lucide";
            ...
            <DropdownMenuContent align="end" className="min-w-48" positionerClassName="z-80">
              ...
              <DropdownMenuSub>
                ...
                <DropdownMenuSubContent className="min-w-44" positionerClassName="z-80">
                  <DropdownMenuRadioGroup
                    value={view.agent}
                    onValueChange={(value: any) => view.setAgent(value as AgentKind | "all")}
                  >
                    <DropdownMenuRadioItem value="all">
              ...
              <DropdownMenuSub>
                ...
                <DropdownMenuSubContent className="min-w-44" positionerClassName="z-80">
                  <DropdownMenuRadioGroup
                    value={view.filter}
                    onValueChange={(value: any) => view.setFilter(value as SessionRecordFilter)}
                  >
              ...
              <DropdownMenuCheckboxItem
                ...
                onCheckedChange={(checked: any) => view.setShowAuxiliary(checked === true)}
              >
